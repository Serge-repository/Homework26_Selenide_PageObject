...
public class ProductListPage extends GeneralPage {
    ...
    String ramSizeUncheck = "//a[contains(@href,'xiaomi')][contains(text(),'%s Гб')]";
    ...
    public ProductListPage unselectRam(String size) {
        closeBanner();
